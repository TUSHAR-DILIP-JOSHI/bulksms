...
$url = "https://www.myvaluefirst.com/smpp/sendsms?username=yourusername&password=yourpassword&to=".$phone."&from=".$fetchcompany."&text=".$texts."&dlr-mask=19&dlr-url&coding=3&category=bulk";
...
curl_close($ch);
    ...
    if ( $textcount>140 & $textcount<210 ){
     ...
     if ( $textcount>210 & $textcount<280 ){
          $data="UPDATE premium_user SET credit = credit-(4*$phonecounts) WHERE username = '$fetchusername' ";
          
    }

     if ( $textcount>280 & $textcount<350 ){
          $data="UPDATE premium_user SET credit = credit-(5*$phonecounts) WHERE username = '$fetchusername' ";
          
    }

     if ( $textcount>350 & $textcount<420 ){
          $data="UPDATE premium_user SET credit = credit-(6*$phonecounts) WHERE username = '$fetchusername' ";
          
    }

     if ( $textcount>420 & $textcount<490 ){
          $data="UPDATE premium_user SET credit = credit-(7*$phonecounts) WHERE username = '$fetchusername' ";
...
<div class="header">
 ...
 <!-- <a href="#default" class="logo">CompanyLogo</a>-->
  <div class="header-right">
    ...
    <a href="profile_premium/profilepage.php"><?php echo $fetchfirstname ?>  <?php echo $fetchlastname ?></a>
    <a href= "https://www.mobilink.co.in/#contact">CREDIT LEFT "<?php echo $fetchcredit ?>"</a>
    <a href="psendsms.php">SEND SMS</a>
    <a href="psendsmsbulk.php">SEND BULKSMS</a>
    <a href="punicode.php"> UNICODE SMS</a>
    <a class="active" href="punicodebulk.php">BULK UNICODE SMS</a>
