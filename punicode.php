...
$phone = $_POST['toname'];
$text = $_POST['messagename']."_from_".$_POST['fromname'];
...
$url = "https://www.myvaluefirst.com/smpp/sendsms?username=yourusername&password=yourpassword&to=".$phone."&from=".$fetchcompany."&text=".$texts."&dlr-mask=19&dlr-url&coding=3";
...
<div class="header">
 ...
 <!-- <a href="#default" class="logo">CompanyLogo</a>-->
  <div class="header-right">
    ...
    <a class="active" href="punicode.php"> UNICODE SMS</a>
...
<div class="bg-contact100" style="background-image: url('images/bg-01.jpg');">
     ...
     <form class="contact100-form validate-form" method= "post"  >
        ...
        <input class="input100" type="text" name="toname" value="" placeholder="ENTER SINGLE MOBILE NUMBER" >
        ...
        <textarea class="input100" name="messagename" value="" placeholder="TYPE ..Message.. HERE YOU WANT TO SEND MAXIMUM 500 CHARACTER PREFERED INCLUDING  YOUR NAME (1 CREDIT PER 70 CHARACTER INCLUDING SPACES) "></textarea>
                                <span class="focus-input100"></span>
                    </div>
