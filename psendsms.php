...
$url = "https://www.myvaluefirst.com/smpp/sendsms?username=yourusername&password=yourpassword&to=".$phone."&from=".$fetchcompany."&text=".$texts."&dlr-mask=19&dlr-url";
...
<div class="header">
 ...
 <!-- <a href="#default" class="logo">CompanyLogo</a>-->
  <div class="header-right">
    ...
    <a class="active" href="#about">SEND SMS</a>
...
<div class="bg-contact100" style="background-image: url('images/bg-01.jpg');">
     ...
     <form class="contact100-form validate-form" method= "post"  >
     	...
     	<textarea class="input100" name="messagename" value="test123msg" placeholder="Message should be less than 160 character including your name for 1 credit"></textarea>
     							<span class="focus-input100"></span>
  					</div>
