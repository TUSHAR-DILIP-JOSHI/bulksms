...
$url = "https://www.myvaluefirst.com/smpp/sendsms?username=yourusername&password=yourpassword&to=".$phone."&from=SHRIGP&text=".$texts."&category=bulk";
...
<div class="header">
 ...
 <!-- <a href="#default" class="logo">CompanyLogo</a>-->
  <div class="header-right">
    ...
    <a class="active" href="sendsmsbulk.php">SEND BULKSMS</a>
