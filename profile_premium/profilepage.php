...
<BR><BR><BR>
				<a href ="http://localhost/hushar/mobilink/psendsms.php"><button class="button button1">CLICK HERE TO SEND SMS</button></a>
	...
	<div class="row">
		<div class="col-md-6 col-sm-12">
			<div class="about">
				...
				<p>  YOUR SENDER SMS NAME IS     ==>   <?php echo $fetchcomoany ?></p>
				<!--
