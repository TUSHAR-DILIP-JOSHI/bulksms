...
$url = "https://www.myvaluefirst.com/smpp/sendsms?username=yourusername&password=yourpassword&to=".$phone."&from=SHRIGP&text=".$texts."&dlr-mask=19&dlr-url&coding=3";
...
<div class="header">
 ...
 <!-- <a href="#default" class="logo">CompanyLogo</a>-->
  <div class="header-right">
    ...
    <a class="active" href="unicode.php"> UNICODE SMS</a>
    <a href="unicodebulk.php">BULK UNICODE SMS</a>
