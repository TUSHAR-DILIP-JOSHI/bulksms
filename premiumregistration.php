...
session_start();
 ...
 if(! $conn ) {
     ...
     $uSENDERNAME = $_POST["SENDERNAMEID"];

     $sql_u = "SELECT * FROM premium_user WHERE username = '$uname' ";

     $res_u = mysqli_query($conn, $sql_u);


             $sql_m = "SELECT * FROM premium_user WHERE mobilenumber = '$umobile' ";

             $res_m = mysqli_query($conn, $sql_m);


                   $sql_email = "SELECT * FROM premium_user WHERE emailid = '$uemailid' ";
     ...
     if(mysqli_num_rows($res_u) > 0) {
      ...
      $sqlo = "INSERT INTO premium_user
      (uid, username, userpassword , firstname, lastname,  mobilenumber, emailid, companyname ) 
      VALUES ( '' ,'$uname','$upwd', '$ufirstname', '$ulastname', '$umobile', '$uemailid', '$uSENDERNAME' )";
...
<div align="center">
  ...
  <table border="0" cellpadding="50px" cellspacing="50px" style="BORDER-COLLAPSE: collapse" width="70%"  id="AutoNumber11" height="90%" border-radius= "25px">
    ...
    <tr>
      ...
      <td width="90%" height="90%" bgcolor=#086FDC align="center" valign="top"><span id="span1" name="span1" style="font-color:#ff0000 font-weight:bold; font-size:10">
		<p>&nbsp;</p>


	<FORM NAME="fNewUser" METHOD="POST">

	<div align="center"><FONT color=#FF0000 size=5><b>PREMIUM MEMBER USER REGISTRATION FORM</b></FONT>
		<br>
	<b><font size="2" face="Tahoma">( '</font><FONT size="2" face="Tahoma" color="red">*</font><font size="2" face="Tahoma">' Mark Fields must not be Empty )</font></b>
		...
		<table align='center' width='95%' height='95%' cellspacing='0' cellpadding='0' border='1' bordercolor=#FF2424 bordercolorlight=#ffffff><tr><td><b>YOUR ACCOUNT WILL START ONCE YOUR SENDER NAME IS APPROVED  PLEASE CONTACT US BEFORE YOU REGISTER</b><TR height='30'><TD bgcolor=#ffffff><FONT size='2' face='Tahoma' color='red'><b>&nbsp;&nbsp;"
	...
	<table align="center" width="95%" cellspacing="0" cellpadding="0" border="1" bordercolor=#DFDEDD bordercolorlight=#FFFFFF><tr><td>
		...
		<table align="center" class="tbl" width="100%"  >
            ...
            <TR>
				<TD align="left"><FONT color="red" size="2"> * </font><font color=#0086CF>Prefered Sender Name:</font></TD>
				<TD width="50%">&nbsp;<INPUT NAME="SENDERNAMEID" size=46 style="WIDTH: 250px; HEIGHT: 30px" value=""placeholder= "ENTER SENDER NAME THAT YOU WANT"></TD>
				<TD><font size="1">Sender name must be of 5 letter , it can be changed, contact us for more information </font></TD>
            </TR>
				<!--
			</TR>
        ...
        <button   class="btn-hover color-1" name="Submit" type="submit"><a href="resistrationuser.php">BACK TO REGULAR LOGIN</a></button>
<!--
